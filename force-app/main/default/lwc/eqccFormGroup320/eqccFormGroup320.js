...
import EQCC_ENMM_020_PRV_BP_Piston from "./forms/EQCC_ENMM_020_PRV_BP_Piston.html";
import EQCC_ENMM_021_Ball_Valve_Service from "./forms/EQCC_ENMM_021_Ball_Valve_Service.html";
...
export default class eqccFormGroup320 extends NavigationMixin(LightningElement) {
    ...
    imgUrl = {
        EQCC_ENMM_020: {
            index0: EQCC_STATIC_RESOURCE + '/eqccForm/EQCC-ENMM-020-01.jpg',
            index1: EQCC_STATIC_RESOURCE + '/eqccForm/EQCC-ENMM-020-02.jpg',
            index2: EQCC_STATIC_RESOURCE + '/eqccForm/EQCC-ENMM-020-03.jpg',
            index3: EQCC_STATIC_RESOURCE + '/eqccForm/EQCC-ENMM-020-04.jpg',
            index4: EQCC_STATIC_RESOURCE + '/eqccForm/EQCC-ENMM-020-05.jpg'
        },
        EQCC_ENMM_021: {
            index0: EQCC_STATIC_RESOURCE + '/eqccForm/EQCC-ENMM-021-01.jpg'
        }
    }
        ...
        switch (this.checkedSheetName) {
            case "EQCC_ENMM_020": {
                switch (this.stepNumber) {
                    case 1:
                        return EQCC_ENMM_020_PRV_BP_Piston;
                    default:
            ...
            case "EQCC_ENMM_021": {
                switch (this.stepNumber) {
                    case 1:
                        return EQCC_ENMM_021_Ball_Valve_Service;
                    default:
                        return defaultTemplate;
                }
            }           
