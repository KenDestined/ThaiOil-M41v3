...
//form
import ENEM_QFR_1015_SWB_Gas_Insulated_Switchgear from "./forms/ENEM-QFR-1015-SWB_Gas_Insulated_Switchgear.html";
import ENEM_QFR_1007_SWB_HV_switchgear_unit_inspection from "./forms/ENEM-QFR-1007-SWB_HV_switchgear_unit_inspection.html";
import ENEM_QFR_1013_SWB_LV_switchgear_and_MCC_Major_inspection_from from "./forms/ENEM-QFR-1013-SWB_LV_switchgear_and_MCC_Major_inspection.html";
import ENEM_QFR_1014_SWB_LV_SWB_Major_inspection from "./forms/ENEM-QFR-1014-SWB-LV_SWB_Major_inspection.html";
import ENEM_QFR_1102_TRN_Transformer_Oil_Sampling_Record from "./forms/ENEM-QFR-1102-TRN-Transformer_Oil_Sampling_Record.html";
import ENEM_QFR_1103_TRA_TRANSFORMER_MINOR_INSPECTION from "./forms/ENEM-QFR-1103-TRA-TRANSFORMER_MINOR_INSPECTION.html";
        ...
        switch (this.checkedSheetName) {
            case "ENEM_QFR_1015": {
                switch (this.stepNumber) {
                    case 1:
                        return ENEM_QFR_1015_SWB_Gas_Insulated_Switchgear;
                    default:
            ...
            case "ENEM_QFR_1007": {
                switch (this.stepNumber) {
                    case 1:
                        return ENEM_QFR_1007_SWB_HV_switchgear_unit_inspection;
                    default:
                        return defaultTemplate;
                }
            }
            case "ENEM_QFR_1013": {
                switch (this.stepNumber) {
                    case 1:
                        return ENEM_QFR_1013_SWB_LV_switchgear_and_MCC_Major_inspection_from;
                    default:
                        return defaultTemplate;
                }
            }
            case "ENEM_QFR_1014": {
                switch (this.stepNumber) {
                    case 1:
                        return ENEM_QFR_1014_SWB_LV_SWB_Major_inspection;
                    default:
                        return defaultTemplate;
                }
            }
            case "ENEM_QFR_1102": {
                switch (this.stepNumber) {
                    case 1:
                        return ENEM_QFR_1102_TRN_Transformer_Oil_Sampling_Record;
                    default:
                        return defaultTemplate;
                }
            }
            case "ENEM_QFR_1103": {
                switch (this.stepNumber) {
                    case 1:
                        return ENEM_QFR_1103_TRA_TRANSFORMER_MINOR_INSPECTION;
                    default:
                        return defaultTemplate;
                }
            }
