    ...
    removeRow(e) {
        ...
        if (shownRows && (["Draft", "Needs Revision", "Recalled"].includes(this.formStatus))) {
            ...
            if (shownRow) {
                ...
                if(this.checkedSheetName === "SIF_Test_Report_Diff_Pressure_Level" ||
                this.checkedSheetName === "SIF_Test_Report_Diff_Pressure_Level  " ||
                this.checkedSheetName === "SIF_Test_Report_Differential_Pressure_TX" )
                {
