...
import EarthResistanceContinuityTesting1 from "./forms/EarthResistanceContinuityTesting1.html";
    ...
    drawDynamicRows() {
        switch (this.checkedSheetName) {
            case "Monthly_Substation_Inspection": {
                switch (this.stepNumber) {
                    case 1:
                        if((this.formStatus == 'Draft' || this.formStatus == 'Recalled' || this.formStatus == 'Pending for Approval' || this.formStatus == 'Approved')) {
            ...
            case "Inspection_Test_Report_Control_VOOV": {
                switch (this.stepNumber) {
                    case 1:
                        if((this.formStatus == 'Draft' || this.formStatus == 'Recalled' || this.formStatus == 'Approved')) {
                            let firstHiddenRow = this.template.querySelector(".hideRow");
