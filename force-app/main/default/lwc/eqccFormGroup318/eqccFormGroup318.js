...
import EQCC_ENMM_015_PVV_Service_Report from "./forms/EQCC_ENMM_015_PVV_Service_Report.html";
import EQCC_ENMM_017_SRV_Pilot_Type from "./forms/EQCC_ENMM_017_SRV_Pilot_Type.html";
...
export default class EqccCheckedSheet31 extends NavigationMixin(LightningElement) {
    ...
    imgUrl = {
        EQCC_ENMM_015: {
            index0: EQCC_STATIC_RESOURCE + '/eqccForm/EQCC-ENMM-015-01.jpg',
            index1: EQCC_STATIC_RESOURCE + '/eqccForm/EQCC-ENMM-015-02.jpg',
            index2: EQCC_STATIC_RESOURCE + '/eqccForm/EQCC-ENMM-015-03.jpg',
            index3: EQCC_STATIC_RESOURCE + '/eqccForm/EQCC-ENMM-015-04.jpg',
            index4: EQCC_STATIC_RESOURCE + '/eqccForm/EQCC-ENMM-015-05.jpg'
        },
        EQCC_ENMM_017: {
            index0: EQCC_STATIC_RESOURCE + '/eqccForm/EQCC-ENMM-017-01.jpg',
            index1: EQCC_STATIC_RESOURCE + '/eqccForm/EQCC-ENMM-017-02.jpg',
            index2: EQCC_STATIC_RESOURCE + '/eqccForm/EQCC-ENMM-017-03.jpg',
            index3: EQCC_STATIC_RESOURCE + '/eqccForm/EQCC-ENMM-017-04.jpg',
            index4: EQCC_STATIC_RESOURCE + '/eqccForm/EQCC-ENMM-017-05.jpg'
        }
    }
        ...
        switch (this.checkedSheetName) {
            case "EQCC_ENMM_017": {
                switch (this.stepNumber) {
                    case 1:
                        return EQCC_ENMM_017_SRV_Pilot_Type;
                    default:
            ...
            case "EQCC_ENMM_015": {
                switch (this.stepNumber) {
                    case 1:
                        return EQCC_ENMM_015_PVV_Service_Report;
                    default:
                        return defaultTemplate;
                }
            }            
    ...
    submitor() {
        getSubmitor({ stepId: this.recordId })
            .then((result) => {
                ...
                this.checkedSheetName == 'EQCC_ENMM_017'
                )
                {
                    this.loadDraft();
                }
