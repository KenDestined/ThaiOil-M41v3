...
//form
import ENEM_QFR_7409_DCLP_CP1_CP2_MONTHLY_INSPECTION from "./forms/ENEM-QFR-7409-DCLP-CP1_CP2_MONTHLY_INSPECTION.html";
import ENEM_QFR_7410_DCLP_CP1_CP2_YEARLY_INSPECTION from "./forms/ENEM-QFR-7410-DCLP-CP1_CP2_YEARLY_INSPECTION.html";
import ENEM_QFR_7506_GNR_INSPECTION_OF_STATIC_SUPPLY_UNIT from "./forms/ENEM-QFR-7506-GNR-INSPECTION_OF_STATIC_SUPPLY_UNIT.html";
import ENEM_QFR_7507_GNR_Battery_Cell_Test from "./forms/ENEM-QFR-7507-GNR-Battery_Cell_Test.html";
import ENEM_QFR_7509_GNR_inspection_of_charger_unit from "./forms/ENEM-QFR-7509-GNR-inspection_of_charger_unit.html";
        ...
        switch (this.checkedSheetName) {
            case "ENEM_QFR_7409": {
                switch (this.stepNumber) {
                    case 1:
                        return ENEM_QFR_7409_DCLP_CP1_CP2_MONTHLY_INSPECTION;
                    default:
            ...
            case "ENEM_QFR_7410": {
                switch (this.stepNumber) {
                    case 1:
                        return ENEM_QFR_7410_DCLP_CP1_CP2_YEARLY_INSPECTION;
                    default:
                        return defaultTemplate;
                }
            }
            case "ENEM_QFR_7506": {
                switch (this.stepNumber) {
                    case 1:
                        return ENEM_QFR_7506_GNR_INSPECTION_OF_STATIC_SUPPLY_UNIT;
                    default:
                        return defaultTemplate;
                }
            }
            case "ENEM_QFR_7507": {
                switch (this.stepNumber) {
                    case 1:
                        return ENEM_QFR_7507_GNR_Battery_Cell_Test;
                    default:
                        return defaultTemplate;
                }
            }
            case "ENEM_QFR_7509": {
                switch (this.stepNumber) {
                    case 1:
                        return ENEM_QFR_7509_GNR_inspection_of_charger_unit;
                    default:
                        return defaultTemplate;
                }
            }
