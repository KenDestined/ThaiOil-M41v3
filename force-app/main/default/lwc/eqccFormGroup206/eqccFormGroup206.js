...
//form
import ENEM_QFR_3001_ELICS_AC450_INSPECTION from "./forms/ENEM-QFR-3001-ELICS-AC450_INSPECTION.html";
import ENEM_QFR_3002_ELICS_ELICS_800M_SYSTEM_INSPECTION from "./forms/ENEM-QFR-3002-ELICS-ELICS_800M_SYSTEM_INSPECTION.html";
/////////////
        ...
        switch (this.checkedSheetName) {
            case "ENEM_QFR_3001": {
                switch (this.stepNumber) {
                    case 1:
                        return ENEM_QFR_3001_ELICS_AC450_INSPECTION;
                    default:
            ...
            case "ENEM_QFR_3002": {
                switch (this.stepNumber) {
                    case 1:
                        return ENEM_QFR_3002_ELICS_ELICS_800M_SYSTEM_INSPECTION;
                    default:
                        return defaultTemplate;
                }
            }
