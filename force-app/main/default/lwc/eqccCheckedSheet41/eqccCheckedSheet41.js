...
import GearDrivenFinFansPreventiveMaintenance1 from "./forms/GearDrivenFinFansPreventiveMaintenance1.html";
import GearDrivenFinFansPreventiveMaintenance2 from "./forms/GearDrivenFinFansPreventiveMaintenance2.html";
import DecanterPreventiveMaintenance from "./forms/DecanterPreventiveMaintenance.html";
import VerticalPumpRemovalAndInstallation1 from "./forms/VerticalPumpRemovalAndInstallation1.html";
import VerticalPumpRemovalAndInstallation2 from "./forms/VerticalPumpRemovalAndInstallation2.html";
import VerticalPumpRemovalAndInstallation3 from "./forms/VerticalPumpRemovalAndInstallation3.html";
import RotorBalancingReport from "./forms/RotorBalancingReport.html";
import OverhungPumpVerticalInlineTypeChecklist from "./forms/OverhungPumpVerticalInlinetypeChecklist.html";
...
import MotorBearingsOnlineGreasing from "./forms/MotorBearingsOnlineGreasing.html";
...
export default class EqccCheckedSheet41 extends NavigationMixin(LightningElement) {
    ...
    render() {
        console.log(this.checkedSheetName, this.stepNumber)
        switch (this.checkedSheetName) {
            ...
            case "Gear_Driven_Fin_Fans_PM": {
                switch (this.stepNumber) {
                    case 1:
                        return GearDrivenFinFansPreventiveMaintenance1;
                    case 2:
                        return GearDrivenFinFansPreventiveMaintenance2;
                    default:
                        return defaultTemplate;
                }
            }
            ...
            case "Vertical_Pump_Removal_And_Installation": {
                switch (this.stepNumber) {
                    case 1:
                        return VerticalPumpRemovalAndInstallation1;
                    case 2:
                        return VerticalPumpRemovalAndInstallation2;
                    case 3:
                        return VerticalPumpRemovalAndInstallation3;
                    default:
                        return defaultTemplate;
                }
            }
            case "Relief_Valve_Test_Certificate": {
                switch (this.stepNumber) {
                    case 1:
                        return ReliefValveTestCertificate;
                    default:
                        return defaultTemplate;
                }
            }
            case "Rotor_Balancing_Report": {
                switch (this.stepNumber) {
                    case 1:
                        return RotorBalancingReport;
                    default:
                        return defaultTemplate;
                }
            }
            case "Overhung_Pump_Vertical_in_line_type": {
                switch (this.stepNumber) {
                    case 1:
                        return OverhungPumpVerticalInlineTypeChecklist;
                    default:
                        return defaultTemplate;
                }
            }
            ...
            case "Motor_Bearings_OnlineGreasing": {
                switch (this.stepNumber) {
                    case 1:
                        return MotorBearingsOnlineGreasing;
                    default:
                        return defaultTemplate;
                }
            }
