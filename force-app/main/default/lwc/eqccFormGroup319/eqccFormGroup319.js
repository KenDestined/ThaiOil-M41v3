...
import EQCC_ENMM_018_Steam_SRV_Report from "./forms/EQCC_ENMM_018_Steam_SRV_Report.html";
import EQCC_ENMM_019_PRV_Adjust_Fixed_Blowdown from "./forms/EQCC_ENMM_019_PRV_Adjust_Fixed_Blowdown.html";
...
export default class eqccFormGroup319 extends NavigationMixin(LightningElement) {
    ...
    imgUrl = {
        EQCC_ENMM_018: {
            index0: EQCC_STATIC_RESOURCE + '/eqccForm/EQCC-ENMM-018-01.jpg',
            index1: EQCC_STATIC_RESOURCE + '/eqccForm/EQCC-ENMM-018-01-1.jpg',
            index2: EQCC_STATIC_RESOURCE + '/eqccForm/EQCC-ENMM-018-01-2.jpg',
            index3: EQCC_STATIC_RESOURCE + '/eqccForm/EQCC-ENMM-018-02.jpg',
            index4: EQCC_STATIC_RESOURCE + '/eqccForm/EQCC-ENMM-018-03.jpg',
            index4: EQCC_STATIC_RESOURCE + '/eqccForm/EQCC-ENMM-018-04.jpg',
            index4: EQCC_STATIC_RESOURCE + '/eqccForm/EQCC-ENMM-018-05.jpg'
        },
        EQCC_ENMM_019: {
            index0: EQCC_STATIC_RESOURCE + '/eqccForm/EQCC-ENMM-019-01.jpg',
            index1: EQCC_STATIC_RESOURCE + '/eqccForm/EQCC-ENMM-019-02.jpg',
            index2: EQCC_STATIC_RESOURCE + '/eqccForm/EQCC-ENMM-019-03.jpg',
            index3: EQCC_STATIC_RESOURCE + '/eqccForm/EQCC-ENMM-019-04.jpg',
            index4: EQCC_STATIC_RESOURCE + '/eqccForm/EQCC-ENMM-019-05.jpg'
        }
    }
        ...
        switch (this.checkedSheetName) {
            case "EQCC_ENMM_018": {
                switch (this.stepNumber) {
                    case 1:
                        return EQCC_ENMM_018_Steam_SRV_Report;
                    default:
            ...
            case "EQCC_ENMM_019": {
                switch (this.stepNumber) {
                    case 1:
                        return EQCC_ENMM_019_PRV_Adjust_Fixed_Blowdown;
                    default:
                        return defaultTemplate;
                }
            }
