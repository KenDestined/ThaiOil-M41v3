...
import SIF_Test_Report_Instrument_Output_to_MCC_or_other_system from "./forms/SIF_Test_Report_Instrument_Output_to_MCC_or_other_system.html";
import SIF_Test_Report_Solenoid_operated_control_or_OnOff_Valve from "./forms/SIF_Test_Report_Solenoid_operated_control_or_OnOff_Valve.html";
import SIF_Test_Report_Solenoid_operated_Hydraulic_valve from "./forms/SIF_Test_Report_Solenoid_operated_Hydraulic_valve.html";
...
export default class eqccFormGroup411 extends NavigationMixin(LightningElement) {
        ...
        switch (this.checkedSheetName) {
            case "ENIM_QFR_072": {
                switch (this.stepNumber) {
                    case 1:
                        return SIF_Test_Report_Instrument_Output_to_MCC_or_other_system;
                    default:
            ...
            case "ENIM_QFR_070": {
                switch (this.stepNumber) {
                    case 1:
                        return SIF_Test_Report_Solenoid_operated_control_or_OnOff_Valve;
                    default:
                        return defaultTemplate;
                }
            }
            case "ENIM_QFR_071": {
                switch (this.stepNumber) {
                    case 1:
                        return SIF_Test_Report_Solenoid_operated_Hydraulic_valve;
                    default:
                        return defaultTemplate;
                }
            }           
