...
export default class EqccCheckedSheet33 extends NavigationMixin(LightningElement) {
    ...
    render() {
        console.log('test check sheet name---'+this.checkedSheetName);
    ...
    removeRow(e) {
        ...
        if (shownRows && (this.formStatus === "Draft" || this.formStatus === "Needs Revision")) {
            ...
            if (shownRow) {
                ...
                if(this.checkedSheetName === "pH_Analyzer_Maintenance_Check_Sheet" ||
                this.checkedSheetName === "Oxygen_Analyzer_Maintenance_Check_Sheet")
                {
    ...
    onIEH(e) {
        ...
        if (e.currentTarget.type === "radio" || e.currentTarget.type === "checkbox") {
            ...
            this.checkedSheetName === "Oxygen_Analyzer_Maintenance_Check_Sheet")
            {
                if (e.currentTarget.value != null && e.currentTarget.value !== "" && e.currentTarget.value !== "false" && e.currentTarget.value !== false) {
