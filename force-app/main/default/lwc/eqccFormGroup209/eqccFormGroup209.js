...
//form
import ENEM_QFR_9045_GNR_Protection_relay_replacement from "./forms/ENEM-QFR-9045-GNR-Protection_relay_replacement.html";
import ENEM_QFR_9047_GNR_Transformer_inspection from "./forms/ENEM-QFR-9047-GNR-Transformer_inspection.html";
import ENEM_QFR_9048_GNR_Voltage_and_Current_Transformer from "./forms/ENEM-QFR-9048-GNR-Voltage_and_Current_Transformer.html";
import ENEM_QFR_9049_GNR_Water_condensed_inspection from "./forms/ENEM-QFR-9049-GNR-Water_condensed_inspection.html";
        ...
        switch (this.checkedSheetName) {
            ...
            case "ENEM_QFR_9045": {
                switch (this.stepNumber) {
                    case 1:
                        return ENEM_QFR_9045_GNR_Protection_relay_replacement;
                    default:
            ...
            case "ENEM_QFR_9047": {
                switch (this.stepNumber) {
                    case 1:
                        return ENEM_QFR_9047_GNR_Transformer_inspection;
                    default:
                        return defaultTemplate;
                }
            }
            case "ENEM_QFR_9048": {
                switch (this.stepNumber) {
                    case 1:
                        return ENEM_QFR_9048_GNR_Voltage_and_Current_Transformer;
                    default:
                        return defaultTemplate;
                }
            }
            case "ENEM_QFR_9049": {
                switch (this.stepNumber) {
                    case 1:
                        return ENEM_QFR_9049_GNR_Water_condensed_inspection;
                    default:
                        return defaultTemplate;
                }
            }
