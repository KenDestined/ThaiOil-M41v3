...
import GI_Test_Report_Solenoid from "./forms/GI_Test_Report_Solenoid.html";
import GI_Installation_Control_OnOff_valve from "./forms/GI_Installation_Control_OnOff_valve.html";
...
export default class eqccFormGroup403 extends NavigationMixin(LightningElement) {
    ...
    imgUrl = {
        ENIM_QFR_80: {
            index0: EQCC_STATIC_RESOURCE + '/eqccForm/ENIM-QFR-080-01.jpg',
            index1: EQCC_STATIC_RESOURCE + '/eqccForm/ENIM-QFR-080-02.jpg'
        }
    }
        ...
        switch (this.checkedSheetName) {
            case "ENIM_QFR_080": {
                switch (this.stepNumber) {
                    case 1:
                        return GI_Test_Report_Solenoid;
                    default:
            ...
            case "ENIM_QFR_082": {
                switch (this.stepNumber) {
                    case 1:
                        return GI_Installation_Control_OnOff_valve;
                    default:
                        return defaultTemplate;
                }
            }            
