...
// kd
import Enemqfr9009 from "./forms/Enemqfr9009.html";
import "./forms/Enemqfr9009.css";
// bee
import Enemqfr1100 from "./forms/Enemqfr1100.html";
import "./forms/Enemqfr1100.css";
//pang
import Enemqfr5003 from "./forms/Enemqfr5003.html";
import Enemqfr5112 from "./forms/Enemqfr5112.html";
import Enemqfr5106 from "./forms/Enemqfr5106.html";
import "./forms/Enemqfr5003.css";
import "./forms/Enemqfr5112.css";
import "./forms/Enemqfr5106.css";
//Gun
import "./forms/Enemqfr4004.css";
import "./forms/Enemqfr4005.css";
import "./forms/Enemqfr4100.css";
import "./forms/Enemqfr4200.css";
import "./forms/Enemqfr4301.css";
import "./forms/Enemqfr4500.css";
import Enemqfr4004 from "./forms/Enemqfr4004.html";
import Enemqfr4005 from "./forms/Enemqfr4005.html";
import Enemqfr4100 from "./forms/Enemqfr4100.html";
import Enemqfr4200 from "./forms/Enemqfr4200.html";
import Enemqfr4301 from "./forms/Enemqfr4301.html";
import Enemqfr4500 from "./forms/Enemqfr4500.html";
...
let Enemqfr4004_Part1 = 0;
let Enemqfr4004_Part2 = 0;
let Enemqfr5003_Part1 = 0;
let Enemqfr4005_Part1 = 0;
let Enemqfr4100_Part1 = 0;
let Enemqfr4301_Part1 = 0;
let Enemqfr4500_Part1 = 0;
// label mapping
// label mapping
export default class eqccFormGroup504 extends NavigationMixin(LightningElement) {
    @api loading = false;
    @api error = false;
    @api readOnly = false;
    @track record;
    ...
    _isModified = false;
    _navigable = true;
    _isModalOpenedOrSelected = false;
    ...
    render() {
        console.log('checkedSheetName => ' + this.checkedSheetName);
    ...
    renderedCallback() {
        if (this.isDifferent === true && !this._isModalOpenedOrSelected) {
            this._isModalOpenedOrSelected = false;
            ...
            if (
                ...
                inputs.forEach((element) => {
                    if(element.dataset.id != "notification" && element.dataset.id != "order" && element.dataset.id != "fl" && element.dataset.id != "status") {
                        let domElement = this.template.querySelector("[data-id='" + element.dataset.id + "']");
                        if (domElement) {
                            if (this.checkedSheetName == "Enemqfr4100" || this.checkedSheetName == "Enemqfr4500") {
    ...
    disableActionButtons() {
        disableButtons(this.template.querySelector("[data-id=saveEQCCStep]"),
                       ...
                       this.template.querySelector("[data-id=addRowPart1]"),
                       this.template.querySelector("[data-id=removeRowPart1]"),
                       this.template.querySelector("[data-id=addRowPart2]"),
                       this.template.querySelector("[data-id=removeRowPart2]"),
                       this.formStatus,
                       isSubmit);
    }
    onKeyPress(e) {
    ...
    drawDynamicRows() {
        switch (this.checkedSheetName) {
            ...
            case "Enemqfr5003": {
                switch (this.stepNumber) {
                    case 1:
                        if((this.formStatus == 'Draft' || this.formStatus == 'Recalled' || this.formStatus == 'Pending for Approval')) {
                            let firstHiddenRow = this.template.querySelector(".hideRow");
                            if (!firstHiddenRow) {
                                let rowsBodySection = this.template.querySelector(".rowsBodySection");
                                if (rowsBodySection) {
                                    rowsBodySection.insertAdjacentHTML("beforeend", dynamicRow("Enemqfr5003"));
                ...
                switch (this.stepNumber) {
                    case 1:
                        if((this.formStatus == 'Draft' || this.formStatus == 'Recalled' || this.formStatus == 'Pending for Approval')) {
                            ...
                            if (!firstHiddenRow) {
                                let rowsBodySection = this.template.querySelector(".rowsBodySection");
                                let rowsBodySection2 = this.template.querySelector(".rowsBodySection2");
                                if (rowsBodySection) {
                                    rowsBodySection.insertAdjacentHTML("beforeend", dynamicRow("Enemqfr4004"));
                                    let inputsList = rowsBodySection.querySelectorAll("input");
                                    inputsList.forEach((input) => {
                                        input.addEventListener("change", this.onIEH.bind(this));
                                    });
                                ...
                                if (rowsBodySection2) {
                                    rowsBodySection2.insertAdjacentHTML("beforeend", dynamicRow("Enemqfr4004-2"));
                                    let inputsList = rowsBodySection2.querySelectorAll("input");
                                    inputsList.forEach((input) => {
                                        input.addEventListener("change", this.onIEH.bind(this));
                                    });
                                }
                    ...
                    case 1:
                        if((this.formStatus == 'Draft' || this.formStatus == 'Recalled' || this.formStatus == 'Pending for Approval')) {
                            ...
                            if (!firstHiddenRow) {
                                let rowsBodySection = this.template.querySelector(".rowsBodySection");
                                if (rowsBodySection) {
                                    rowsBodySection.insertAdjacentHTML("beforeend", dynamicRow("Enemqfr4005"));
                                    let inputsList = rowsBodySection.querySelectorAll("input");
                                    inputsList.forEach((input) => {
                                        input.addEventListener("change", this.onIEH.bind(this));
                                    });
                    ...
                    case 1:
                        //if((this.formStatus == 'Draft' || this.formStatus == 'Recalled' || this.formStatus == 'Pending for Approval')) {
                            ...
                            if (!firstHiddenRow) {
                                let rowsBodySection = this.template.querySelector(".rowsBodySection");
                                if (rowsBodySection) {
                                    rowsBodySection.parentElement.insertAdjacentHTML("beforeend", dynamicRow("Enemqfr4100"));
                                    let inputsList = rowsBodySection.querySelectorAll("input");
                                    inputsList.forEach((input) => {
                                        input.addEventListener("change", this.onIEH.bind(this));
                                    });
                    ...
                    case 1:
                        if((this.formStatus == 'Draft' || this.formStatus == 'Recalled' || this.formStatus == 'Pending for Approval')) {
                            ...
                            if (!firstHiddenRow) {
                                let rowsBodySection = this.template.querySelector(".rowsBodySection");
                                if (rowsBodySection) {
                                    rowsBodySection.insertAdjacentHTML("beforeend", dynamicRow("Enemqfr4301"));
                                    let inputsList = rowsBodySection.querySelectorAll("input");
                                    inputsList.forEach((input) => {
                                        input.addEventListener("change", this.onIEH.bind(this));
                                    });
                    ...
                    case 1:
                        //if((this.formStatus == 'Draft' || this.formStatus == 'Recalled' || this.formStatus == 'Pending for Approval')) {
                            ...
                            if (!firstHiddenRow) {
                                let rowsBodySection = this.template.querySelector(".rowsBodySection");
                                if (rowsBodySection) {
                                    rowsBodySection.parentElement.insertAdjacentHTML("beforeend", dynamicRow("Enemqfr4500"));
                                    let inputsList = rowsBodySection.querySelectorAll("input");
                                    inputsList.forEach((input) => {
                                        input.addEventListener("change", this.onIEH.bind(this));
                                    });
    ...
    loadDraft() {
        if (
            this.checkedSheetName === "Enemqfr5003" ||
            this.checkedSheetName === "Enemqfr5106" ||
            this.checkedSheetName === "Enemqfr4004" ||
            this.checkedSheetName === "Enemqfr4005" ||
            this.checkedSheetName === "Enemqfr4100" ||
            this.checkedSheetName === "Enemqfr4301" ||
            this.checkedSheetName === "Enemqfr4500"
        ) { 
            ...
            switch (this.checkedSheetName) {
                ...
                case "Enemqfr4500":
                    ...
                    if (inputs == null) {
                        ...
                        this.showTextP1 = true;
                        this.showTextP2 = false;
                    } else {
                        inputs.forEach((element) => {
                            if (element.id === 'p1') {
                                this.showTextP1 = element.value;
                            }
                            if (element.id === 'p2') {
                                this.showTextP2 = element.value;
                            }
                        })
                        inputs.forEach((element) => {
                                ...
                                if (domElement.type === "radio" || domElement.type === "checkbox") {
                                    ...
                                    if (pattern.test(element.id)) {
                                        ...
                                        if (element.id === "status") {
                                            if (this.formStatus === "Needs Revision") {
    ...
    addRow(e) {
        ...
        console.log('checkedSheetName => '+ this.checkedSheetName) ;
        if (this.checkedSheetName === 'Enemqfr4301'){
            if (addRow == 'addRowPart1'){
                Enemqfr4301_Part1++;
            }
        } else if(this.checkedSheetName === 'Enemqfr4004') {
            if(addRow == 'addRowPart1'){
                Enemqfr4004_Part1++;
            }
        } else if (this.checkedSheetName === 'Enemqfr4004-2') {
            if (addRow == 'addRowPart2'){
                Enemqfr4004_Part2++;
            }
        } else if (this.checkedSheetName === 'Enemqfr5003') {
            if (addRow == 'addRowPart1'){
                Enemqfr5003_Part1++;
            }
        } else if (this.checkedSheetName === 'Enemqfr4005') {
            if (addRow == 'addRowPart1'){
                Enemqfr4005_Part1++;
            }
        } else if (this.checkedSheetName === 'Enemqfr4100') {
            if (addRow == 'addRowPart1'){
                Enemqfr4100_Part1++;
            }
        } else if (this.checkedSheetName === 'Enemqfr4500') {
            if (addRow == 'addRowPart1') {
                Enemqfr4500_Part1++
            }
        }
        ...
        if (dynamicRowsSection && (this.formStatus === "Draft" || this.formStatus === "Needs Revision" || this.formStatus === "Recalled")) {
            ...
            let hiddenRow;
            if (this.checkedSheetName === 'Enemqfr4100' || this.checkedSheetName === 'Enemqfr4500') {
                hiddenRow = dynamicRowsSection.parentElement.querySelector(".hideRow");
            } else {
                hiddenRow = dynamicRowsSection.querySelector(".hideRow");
            }
            if (hiddenRow) {
    ...
    removeRow(e) {
        ...
        if(this.checkedSheetName == 'Enemqfr5003') {
            if((removeRow == 'removeRowPart1') && (Enemqfr5003_Part1 > 0)) {
                Enemqfr5003_Part1 = Enemqfr5003_Part1 - 1;
            }
        } else if (this.checkedSheetName == 'Enemqfr4004') {
            if((removeRow == 'removeRowPart1') && (Enemqfr4004_Part1 > 0)) {
                Enemqfr4004_Part1 = Enemqfr4004_Part1 - 1;
            }
        } else if (this.checkedSheetName == 'Enemqfr4004-2') {
            if((removeRow == 'removeRowPart2') && (Enemqfr4004_Part2 > 0)) {
                Enemqfr4004_Part2 = Enemqfr4004_Part2 - 1;
            }
        } else if (this.checkedSheetName == 'Enemqfr4005') {
            if((removeRow == 'removeRowPart1') && (Enemqfr4005_Part1 >0)){
                Enemqfr4005_Part1 = Enemqfr4005_Part1 - 1;
            }
        } else if (this.checkedSheetName == 'Enemqfr4100') {
            if((removeRow == 'removeRowPart1') && (Enemqfr4100_Part1 >0)){
                Enemqfr4100_Part1 = Enemqfr4100_Part1 - 1;
            }  
        } else if (this.checkedSheetName == 'Enemqfr4301') {
            if((removeRow == 'removeRowPart1') && (Enemqfr4301_Part1 >0)){
                Enemqfr4301_Part1 = Enemqfr4301_Part1 - 1;
            }
        } else if (this.checkedSheetName == 'Enemqfr4500_Part1') {
            if ((removeRow == 'removeRowPart1') && (Enemqfr4500_Part1 > 0)) {
                Enemqfr4500_Part1 = Enemqfr4500_Part1 - 1;
            }
        }
        // let dynamicRowsSection = e.currentTarget.closest(".dynamicRows");
        let dynamicRowsSection;
        if (this.checkedSheetName === 'Enemqfr4100' || this.checkedSheetName === 'Enemqfr4500') {
            dynamicRowsSection = e.currentTarget.closest(".dynamicRows").parentElement;
        } else {
            dynamicRowsSection = e.currentTarget.closest(".dynamicRows");
        }
        ...
        if (!inputNA || !inputNA.checked) {
            ...
            if (question) {
                ...
                for (i = 0; i < answers.length; i++) {
                    if ((this.checkedSheetName == 'Enemqfr4100' || this.checkedSheetName == 'Enemqfr4500')) {
                        if (pattern.test(answers[i].dataset.id)) continue;
                    }                    
    ...
    openSaveModal() {
        this._isModalOpenedOrSelected = true;
    ...
    pageChange2() {
        this.showTextP2 = true;
        this.showTextP1 = false;
    }
    //pang
    showNo = false;
    showInputNo() {
