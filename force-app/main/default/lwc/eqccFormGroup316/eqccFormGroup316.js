...
import EQCC_ENMM_011_Emergency_Vent_Repair from "./forms/EQCC_ENMM_011_Emergency_Vent_Repair.html";
import EQCC_ENMM_012_Relief_Valve_test from "./forms/EQCC_ENMM_012_Relief_Valve_test.html";
...
export default class eqccFormGroup316 extends NavigationMixin(LightningElement) {
    ...
    imgUrl = {
        EQCC_ENMM_011: {
            index0: EQCC_STATIC_RESOURCE + '/eqccForm/EQCC-ENMM-011-01.jpg',
            index1: EQCC_STATIC_RESOURCE + '/eqccForm/EQCC-ENMM-011-02.jpg',
            index2: EQCC_STATIC_RESOURCE + '/eqccForm/EQCC-ENMM-011-03.jpg',
            index3: EQCC_STATIC_RESOURCE + '/eqccForm/EQCC-ENMM-011-04.jpg',
            index4: EQCC_STATIC_RESOURCE + '/eqccForm/EQCC-ENMM-011-05.jpg'
        }
    }
        ...
        switch (this.checkedSheetName) {
            case "EQCC_ENMM_011": {
                switch (this.stepNumber) {
                    case 1:
                        return EQCC_ENMM_011_Emergency_Vent_Repair;
                    default:
            ...
            case "EQCC_ENMM_012": {
                switch (this.stepNumber) {
                    case 1:
                        return EQCC_ENMM_012_Relief_Valve_test;
                    default:
                        return defaultTemplate;
                }
            }
