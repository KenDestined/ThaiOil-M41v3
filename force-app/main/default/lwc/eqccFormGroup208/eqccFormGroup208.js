...
//form
import ENEM_QFR_9036_GNR_Check_HEATER_CONTROL_PANEL_6M from "./forms/ENEM-QFR-9036-GNR-Check_HEATER_CONTROL_PANEL_6M.html";
import ENEM_QFR_9029_GNR__ELECTRICAL_IGNITER_INSPECTION from "./forms/ENEM-QFR-9029-GNR_ELECTRICAL_IGNITER_INSPECTION.html";
import ENEM_QFR_9038_GRN_MOV_PREVENTIVE_INSPECTION from "./forms/ENEM-QFR-9038-GRN-MOV_PREVENTIVE_INSPECTION.html";
import ENEM_QFR_9039_GNR_MOV_visual_inspection from "./forms/ENEM-QFR-9039-GNR_MOV_visual_inspection.html";
import ENEM_QFR_9041_GNR_Emergency_Generator_inspection from "./forms/ENEM-QFR-9041-GNR_Emergency_Generator_inspection.html";
import ENEM_QFR_9042_GNR_LEAD_BATTERY_MAINTENANCE_AND_REPLACEMENT from "./forms/ENEM-QFR-9042-GNR-LEAD_BATTERY_MAINTENANCE_AND_REPLACEMENT.html";
        ...
        switch (this.checkedSheetName) {
            case "ENEM_QFR_9036": {
                switch (this.stepNumber) {
                    case 1:
                        return ENEM_QFR_9036_GNR_Check_HEATER_CONTROL_PANEL_6M;
                    default:
            ...
            case "ENEM_QFR_9038": {
                switch (this.stepNumber) {
                    case 1:
                        return ENEM_QFR_9038_GRN_MOV_PREVENTIVE_INSPECTION;
                    default:
                        return defaultTemplate;
                }
            }
            case "ENEM_QFR_9029": {
                switch (this.stepNumber) {
                    case 1:
                        return ENEM_QFR_9029_GNR__ELECTRICAL_IGNITER_INSPECTION
                        ;
                    default:
                        return defaultTemplate;
                }
            ...
            case "ENEM_QFR_9039": {
                switch (this.stepNumber) {
                    case 1:
                        return ENEM_QFR_9039_GNR_MOV_visual_inspection;
                    default:
                        return defaultTemplate;
                }
            }
            case "ENEM_QFR_9041": {
                switch (this.stepNumber) {
                    case 1:
                        return ENEM_QFR_9041_GNR_Emergency_Generator_inspection;
                    default:
                        return defaultTemplate;
                }
            }
            case "ENEM_QFR_9042": {
                switch (this.stepNumber) {
                    case 1:
                        return ENEM_QFR_9042_GNR_LEAD_BATTERY_MAINTENANCE_AND_REPLACEMENT;
                    default:
                        return defaultTemplate;
                }
            }
