...
import Q_Acid_Concentration_ANL from "./forms/Q_Acid_Concentration_ANL.html";
import Q_Benzene_ANL from "./forms/Q_Benzene_ANL.html";
import Q_Caustic_Concentration_ANL from "./forms/Q_Caustic_Concentration_ANL.html";
import Q_CH4VRU_ANL from "./forms/Q_CH4VRU_ANL.html";
import Q_Octane_ANL from "./forms/Q_Octane_ANL.html";
...
export default class eqccFormGroup506 extends NavigationMixin(LightningElement) {
        ...
        switch (this.checkedSheetName) {
            case 'ENIM_QFR_712': {
                switch (this.stepNumber) {
                    case 1:
                        return Q_Acid_Concentration_ANL
                    default:
            ...
            case 'ENIM_QFR_714': {
                switch (this.stepNumber) {
                    case 1:
                        return Q_Caustic_Concentration_ANL
                    default:
                        return defaultTemplate
                }
            }
