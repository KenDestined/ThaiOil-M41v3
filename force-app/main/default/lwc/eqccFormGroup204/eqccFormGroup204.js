...
// label mapping
import { disableButtons, dynamicRow, enim_qfr_081 } from './utils';
...
//form
import ENEM_QFR_1204_G5001_G5002_BRUSH_AND_COMMUTATOR_INSPECTION  from "./forms/ENEM-QFR-1204-G5001-G5002_BRUSH_AND_COMMUTATOR_INSPECTION.html";
import ENEM_QFR_1205_GEN_G5001_Brush_Slip_ring_inspection_and_maintenance_record from "./forms/ENEM-QFR-1205-GEN_G5001_Brush_Slip_ring_inspection_and_maintenance_record.html";
import ENEM_QFR_1206_GEN_G5003_5004_Brush_and_Commutator_inspection_and_maintenance_record from "./forms/ENEM-QFR-1206-GEN_G5003_G5004_Brush_and_Commutator_inspection_and_maintenance_record.html";
import ENEM_QFR_1207_GEN_G5003_5004_Brush_and_Slip_ring_inspection_and_maintenance_record from "./forms/ENEM-QFR-1207-GEN_G5003_G5004_Brush_and_Slip_ring_inspection_and_maintenance_record.html";
import ENEM_QFR_1208_GEN_G5005_Brush_and_Commutator_inspection_and_maintenance_record from "./forms/ENEM-QFR-1208-GEN_G5005_Brush_and_Commutator_inspection_and_maintenance_record.html";
import ENEM_QFR_1211_GEN_G5006_Brush_and_slip_ring_inspection_and_maintenance_record from "./forms/ENEM-QFR-1211_GEN_G5006_Brush_and_slip_ring_inspection_and_maintenance_record.html";
/////////////////////
...
export default class EqccCheckedSheet21 extends NavigationMixin(LightningElement) {
        ...
        switch (this.checkedSheetName) {
            case "ENEM_QFR_1204": {
                switch (this.stepNumber) {
                    case 1:
                        return ENEM_QFR_1204_G5001_G5002_BRUSH_AND_COMMUTATOR_INSPECTION;
                    default:
            ...
            case "ENEM_QFR_1205": {
                switch (this.stepNumber) {
                    case 1:
                        return ENEM_QFR_1205_GEN_G5001_Brush_Slip_ring_inspection_and_maintenance_record;
                    default:
                        return defaultTemplate;
                }
            }
            case "ENEM_QFR_1206": {
                switch (this.stepNumber) {
                    case 1:
                        return ENEM_QFR_1206_GEN_G5003_5004_Brush_and_Commutator_inspection_and_maintenance_record;
                    default:
                        return defaultTemplate;
                }
            }
            case "ENEM_QFR_1207": {
                switch (this.stepNumber) {
                    case 1:
                        return ENEM_QFR_1207_GEN_G5003_5004_Brush_and_Slip_ring_inspection_and_maintenance_record;
                    default:
                        return defaultTemplate;
                }
            }
            case "ENEM_QFR_1208": {
                switch (this.stepNumber) {
                    case 1:
                        return ENEM_QFR_1208_GEN_G5005_Brush_and_Commutator_inspection_and_maintenance_record;
                    default:
                        return defaultTemplate;
                }
            }
            case "ENEM_QFR_1211": {
                switch (this.stepNumber) {
                    case 1:
                        return ENEM_QFR_1211_GEN_G5006_Brush_and_slip_ring_inspection_and_maintenance_record;
                    default:
                        return defaultTemplate;
                }
            }
