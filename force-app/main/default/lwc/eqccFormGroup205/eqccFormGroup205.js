...
//form
import ENEM_QFR_2601_1_REL_Earth_Pit_Inspection from "./forms/ENEM-QFR-2601-1-REL-Earth_Pit_Inspection.html";
import ENEM_QFR_2601_3_REL_Earth_Pit_Inspection from "./forms/ENEM-QFR-2601-3-REL-Earth_Pit_Inspection.html";
import ENEM_QFR_2603_REL_Earthing_Boss_Tank from "./forms/ENEM-QFR-2603-REL-Earthing_Boss_Tank.html";
...
export default class EqccCheckedSheet21 extends NavigationMixin(LightningElement) {
    ...
    render() {
        switch (this.checkedSheetName) {
            case "ENEM_QFR_2601_1": {
                switch (this.stepNumber) {
                    case 1:
                        return ENEM_QFR_2601_1_REL_Earth_Pit_Inspection;
                    default:
                        return defaultTemplate;
                }
            }
            case "ENEM_QFR_2601_3": {
                switch (this.stepNumber) {
                    case 1:
                        return ENEM_QFR_2601_3_REL_Earth_Pit_Inspection;
                    default:
                        return defaultTemplate;
                }
            }
            case "ENEM_QFR_2603": {
                switch (this.stepNumber) {
                    case 1:
                        return ENEM_QFR_2603_REL_Earthing_Boss_Tank;
                    default:
                        return defaultTemplate;
                }
            }
