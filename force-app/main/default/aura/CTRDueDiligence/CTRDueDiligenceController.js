({
    ...
    handleSubmit : function(component, event, helper) {
        ...
        if(component.get('v.isCMReview')) {
            ...
            //     console.log('Debug#1 v.recordObject.RecordType.DeveloperName',component.get("v.recordObject.RecordType.DeveloperName"))
            //     if(!$A.util.isEmpty(component.get("v.recordObject.RecordType.DeveloperName")) && !component.get("v.recordObject.RecordType.DeveloperName").includes('Edit')) {
            ...
            //     }
            // }
            if(!$A.util.isEmpty(reviewResult) && reviewResult == 'No') { //UATIS-INTCUS-01-1707
                isRejected = true;
            } else {
                console.log('Debug#2 v.recordObject.RecordType.DeveloperName',component.get("v.recordObject.RecordType.DeveloperName"))
                if(!$A.util.isEmpty(component.get("v.recordObject.RecordType.DeveloperName")) && !component.get("v.recordObject.RecordType.DeveloperName").includes('Edit')) {
                    if(component.get('v.isSupplier')) { // 26/03/2024
                        if(component.get('v.isTX')) {
                            fieldsToUpdate['Approval_Step__c'] = 'Select Committee';
        ...
        console.log('reviewResult',actionByApiName,reviewResult,isRejected)
        if(isRejected) {
    ...
    handleRecordUpdated : function(component, event, helper) {
        ...
        console.log('[handleRecordUpdated] isHighHighRisk -----', component.get('v.isHighHighRisk'), component.get('v.isRejected'));
