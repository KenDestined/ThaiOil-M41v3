({
    doInit: function (component, event, helper) {
        ...
        console.log(' Sales org:'+JSON.stringify(component.get("v.SalesOrgMapping")) );
        if(component.get('v.isSupplier'))
        {
            var supplproduct = component.get('v.selectedProductType');
            if(supplproduct.includes("Other Products") || supplproduct.includes("Petroleum and Components"))
                {
    ...
    handleInterestProductCustomerChange : function(component,event,helper) 
    {
        ...
        else
        {
            ...
            var salesorg = helper.ProductMappingv2(component, custproduct, 'Customer');
    ...
    handleInterestProductSupplierChange : function(component,event,helper) 
    {
        ...
        if(supplproduct)
        {
            ...
            else
            {
                ...
                component.set('v.isOtherProducts',false);
                var comCode = helper.ProductMappingv2(component, supplproduct, 'Supplier');
                // component.set('v.PurchasingOrg',comCode);
                component.find('CompanyCodeTOP__c').set('v.value',comCode);
        ...
        {
            component.set('v.isOtherProducts',false);
            component.find('CompanyCodeTOP__c').set('v.value','');
            // component.set('v.PurchasingOrg','');
        }

        // console.log('Debug PurchasingOrg',component.get('v.PurchasingOrg'))
    },
})