({
    ...
    ProductMappingv2: function (component, ProductName, Type) {
        var salesorg = component.get('v.SalesOrg');
        var salesorgMap = (component.get("v.SalesOrgMapping"))?component.get("v.SalesOrgMapping"):[];
        console.log('ProductName:'+ProductName);
        if(salesorgMap)
        {

            salesorg = salesorgMap[ProductName];
        }
        console.log('salesorgv2:'+component.get(salesorg));
        return salesorg;
    }
})