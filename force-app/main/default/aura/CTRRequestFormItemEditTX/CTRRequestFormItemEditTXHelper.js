({
    retrieveRecordType : function(component) {
        ...
        if(!$A.util.isEmpty(component.get("v.recordObject"))) {
            if(!$A.util.isEmpty(component.get("v.recordObject.RecordTypeId"))) {
                ...
                if(component.get('v.recordObject.RecordType.DeveloperName').includes('Supplier') && component.get('v.recordObject.Status__c') == 'In Review') {
                    component.set('v.isRequiredBillingDoc',true);
                }
                console.log('Debug isRequiredBillingDoc',component.get('v.isRequiredBillingDoc'));
    ...
    {
        if((component.get('v.recordTypeName') && component.get('v.recordTypeName').includes('Edit')) || 
        (component.get('v.recordObject.Status__c') == 'In Review' && component.get('v.recordTypeName').includes('Supplier') && component.get('v.bu') == 'TX'))
        {
    ...
    handleCreditActor: function (component) {
        if(component.get('v.recordObject.Status__c') == 'In Review') {
            component.set('v.isCreditActor',true);
        }
    },
})