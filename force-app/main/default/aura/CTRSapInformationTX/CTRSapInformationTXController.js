({
    doInit : function(component, event, helper) {
        ...
        var header = component.get('v.requestFormHeaderObj');
        
        var WhereCityCondition = "AND Type__c = 'Province' ";
        if(header.Country__c)
        {
            WhereCityCondition += "AND RelatedMasterMap1__c = '"+header.Country__c+"'";
        }
        component.set('v.WhereCityCondition', WhereCityCondition);
