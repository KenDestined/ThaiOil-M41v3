        ...
        action.setCallback(this, function(response) {
            ...
            if(state === "SUCCESS") {
                try
                {
                    ...
                    var Yearofexperience = result.CTRRequestFormHeader__r.YearsofExperience__c;
                    ...
                    else
                    {
                        ...
                        console.log('---result.YearsofExperience__c---'+result.CTRRequestFormHeader__r.YearsofExperience__c);
                        ...
                        if(result)
                        {
                            ...
                            if(scoreby == null || scoreby == undefined)
                            {
                                ...
                                if(buInfo.BusinessUnit__c == 'TOP'){
                                    ...
                                    if(Country == 'TH' && SalesOrgTOP == '1100')
                                    {
                                        ...
                                        // }
                                        if(NoOfRegistrationMinistryEnergy == 'FuelTransporter')
                                        {
                                            component.find("NumberRegistrationMinistryEnergy__c").set("v.value", '4'); 
                                        }
                                        else if(NoOfRegistrationMinistryEnergy == 'ServiceStation')
                                        {
                                            component.find("NumberRegistrationMinistryEnergy__c").set("v.value", '4'); 
                                        }
                                        else if(NoOfRegistrationMinistryEnergy == 'Between36And120')
                                        {
                                            component.find("NumberRegistrationMinistryEnergy__c").set("v.value", '4'); 
                                        }
                                        else if(NoOfRegistrationMinistryEnergy == 'MoreThan120')
                                        {
                                            component.find("NumberRegistrationMinistryEnergy__c").set("v.value", '4'); 
                                        }
                                        else if(NoOfRegistrationMinistryEnergy == 'No license') 
                                        {
                                            component.find("NumberRegistrationMinistryEnergy__c").set("v.value", '1');
                                        }
                                    }
                                ...
                                console.log('TheLevelOfExperience__c : ' + component.find("TheLevelOfExperience__c").get("v.value"));
                            ...
                            if(Country == 'TH')
                            {
                                component.set("v.IsDomesticRequired",true);
                                component.set("v.IsInterRequired",false);
                            }
                            else
                            {
                                component.set("v.IsDomesticRequired",false);
                                component.set("v.IsInterRequired",true);
                            }
                        }
                    }
                }
