    ...
    checkRequiredFieldsv2: function (component) {
        ...
        if (component.get('v.isTX')) {
            ...
            if (recordTypeNameCustomer) {
                ...
                //if (!requestFormHeaderObj.PostalCodeLocalText__c || requestFormHeaderObj.PostalCodeLocalText__c.length == 0) { ValidateGeneralList.push('Postal Code ') }
                if (!requestFormHeaderObj.CityStateLocal__c || requestFormHeaderObj.CityStateLocal__c.length < 15) { ValidateGeneralList.push('City ') }
                ...
                //if (!requestFormHeaderObj.CityStateEN__c || requestFormHeaderObj.CityStateEN__c.length < 15) { ValidateGeneralList.push('City EN ') }
            ...
            // Check RecordType contains Supplier
                ...
                if (!requestFormItemObj.Incoterms2__c) { ValidatePurchasingList.push('Incoterms2 ') }
            ...
            if (recordTypeNameCustomer) {
                ...
                if (!requestFormHeaderObj.DistrictLocalText__c) { ValidateGeneralList.push('District ') }
                //if (!requestFormHeaderObj.PostalCodeLocalText__c) { ValidateGeneralList.push('Postal Code ') }
                if (!requestFormHeaderObj.CityStateLocal__c || requestFormHeaderObj.CityStateLocal__c.length < 15) { ValidateGeneralList.push('City ') }
