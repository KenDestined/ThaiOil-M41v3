({
    ...
    getSummarizeReport: function (component) {
        ...
        action.setCallback(this, function (response) {
            ...
            if (state === "SUCCESS") {
                ...
                // if (!sumRep.SummarizeReportEmailCC__c) {
                //     if (sumRep.CreditOwner__r) {
                //         console.log('1 :' );
                //         component.set('v.selectedEmailCC', sumRep.CreditOwner__r.Email + ', ' + sumRep.MDCName__r.Email);
                //     }
                // } else {
                ...
                //             if (!sumRep.SummarizeReportEmailCC__c.includes(sumRep.CreditOwner__r.Email)) {
                //                 component.set('v.selectedEmailCC', sumRep.SummarizeReportEmailCC__c);// + ', ' + sumRep.CreditOwner__r.Email);
                //             }
                //         }
                //     }
    ...
    getMailApprovalReport: function (component, sumRep) {
        ...
        console.log('sumRep.SummarizeReportEmailCC__c:'+sumRep.SummarizeReportEmailCC__c);
    ...
    getProfileName: function (component) {
        ...
        action.setCallback(this, function (response) {
            ...
            if (state === "SUCCESS") {
                ...
                var recordtypeName = profileInfo['RecordType'];
                console.log('recordtypeName include : ' + (!recordtypeName.includes('CrCond')));
                console.log("component.get('v.profile'): "+ businessUnit);
                console.log("component.get('v.recordtypeName'): "+ recordtypeName);
                
                if (!recordtypeName.includes('CrCond')) 
                {
                    ...
                    if ((component.get('v.profile') == 'TOP' || component.get('v.profile') == 'LABIX') && (component.get('v.approvalStep') == 'Approved' || component.get('v.approvalStep') == 'Inform Counterparty')) {
                    ...
                    } else if ((component.get('v.profile') == 'TX' || component.get('v.profile') == 'System Administrator') && (component.get('v.approvalStep') == 'Approved' || component.get('v.approvalStep') == 'Inform Counterparty')) {
                        ...
                        component.set('v.templateType', 'Rejected Summarize Report TX');
                            ...
                            $A.get('e.force:refreshView').fire();
                            if ((component.get('v.profile') == 'TOP' && recordtypeName.includes('Customer')) && component.get('v.approvalStep') == 'Approved') {
                                component.set('v.templateType', 'TOP Cus Change Credit Cond Approved Summarize Report');
                            } else if ((component.get('v.profile') == 'TOP' && recordtypeName.includes('Supplier')) && component.get('v.approvalStep') == 'Approved') {
                                component.set('v.templateType', 'TOP Sup Change Credit Cond Approved Summarize Report');
                            } else if ((component.get('v.profile') == 'LABIX' && recordtypeName.includes('Customer')) && component.get('v.approvalStep') == 'Approved') {
                                component.set('v.templateType', 'LABIX Cus Change Credit Cond Approved Summarize Report');
                            } else if ((component.get('v.profile') == 'TX' && recordtypeName.includes('Customer')) && component.get('v.approvalStep') == 'Approved') {
                                component.set('v.templateType', 'TX Cus Change Credit Cond Approved Summarize Report');
                            } else if ((component.get('v.profile') == 'TOP' && recordtypeName.includes('Customer')) && component.get('v.approvalStep') == 'Rejected') {
                                component.set('v.templateType', 'TOP Cus Change Credit Cond Rejected Summarize Report');
                            } else if ((component.get('v.profile') == 'TOP' && recordtypeName.includes('Supplier')) && component.get('v.approvalStep') == 'Rejected') {
                                component.set('v.templateType', 'TOP Sup Change Credit Cond Rejected Summarize Report');
                            } else if ((component.get('v.profile') == 'LABIX' && recordtypeName.includes('Customer')) && component.get('v.approvalStep') == 'Rejected') {
                                component.set('v.templateType', 'LABIX Cus Change Credit Cond Rejected Summarize Report');
                            } else if ((component.get('v.profile') == 'TX' && recordtypeName.includes('Customer')) && component.get('v.approvalStep') == 'Rejected') {
                                component.set('v.templateType', 'TX Cus Change Credit Cond Rejected Summarize Report');
                            }
                    }
    ...
    getEmailTo: function (sumRep) {
        const email = [];
        console.log('sumRep.SummarizeReportEmailTo__c : ' + sumRep.SummarizeReportEmailTo__c)
        if(sumRep && sumRep.SummarizeReportEmailTo__c)
        {
            const allEmail = sumRep.SummarizeReportEmailTo__c.split(",");
            for(var currentemail of allEmail)
            {
        ...
        // if (sumRep
        //     && sumRep.Owner
        //     && sumRep.Owner.Email && !email.includes(sumRep.Owner.Email)
        // ) email.push(sumRep.Owner.Email);

        // if (sumRep
        //     && sumRep.OwnersSectionHead__r
        //     && sumRep.OwnersSectionHead__r.Email && !email.includes(sumRep.OwnersSectionHead__r.Email)
        // ) email.push(sumRep.OwnersSectionHead__r.Email);

        // if (sumRep 
        //     && sumRep.OwnersCMVP__r
        //     && sumRep.OwnersCMVP__r.Email && !email.includes(sumRep.OwnersCMVP__r.Email)
