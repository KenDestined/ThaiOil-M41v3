({
    ...
    getBu: function (component) {
        ...
        action.setCallback(this, function (response) {
            ...
            if (state === "SUCCESS") {
                ...
                var subBU = requestObj.SubBU__c;
                if(requestObj.SubBU__c == 'TXTH') {
                    if(requestObj.CTRRequestFormHeader__r.Country__c && requestObj.CTRRequestFormHeader__r.Country__r.Code__c == 'TH') {
                        subBU = 'TXTHDOM';
                    } else {
                        subBU = 'TXTHEXP';
                    }
                }
                component.set('v.subBU', subBU)
    ...
    getMetaDocList: function (component) {
        ...
        console.log('Debug get metadatalist with subBU=',component.get('v.subBU'))
        action.setParams({
